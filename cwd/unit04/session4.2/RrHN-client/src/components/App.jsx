...
export class RrHNApp extends React.Component {
   ...
   dialogClickHandler = () => {
      this.setState(() => ({
         selectedItem: '',
         dialogVisibile: !this.state.dialogVisibile
      }));
   }
   ...
   render() {
      ...
      if (this.state.dialogVisibile === true) {
         ...
         itemPanel = <Preferences setColor={boundSetColor} dialogClickHandler={boundDialogClickHandler} setListSize={boundSetListSize} color={this.state.preferences.color} listSize={this.state.preferences.listSize}></Preferences>
      } else {
            ...
            <div id="ListPanel">
               <div className="ItemList">
                  <div className="Logo">
                     ...
                     <span className="settingsIcon" onClick={this.dialogClickHandler}>
