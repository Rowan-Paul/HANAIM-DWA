...
class ItemListUI extends React.Component {
  componentDidMount() {
    this.props.onItemsLoad();
    this.props.onStatusesLoad();
  }
  ...
  render() {
    ...
    return (
      <div className="ItemList">
        ...
        <button
          id="markAsSeen"
          onClick={() => this.props.onMarkAsSeen(this.props.items, this.props.listSize)}
        >
...
function mapDispatchToProps(dispatch) {
  return {
    ...
    onMarkAsSeen: (items, listSize) => dispatch(markAsSeenAction(items,listSize)),
    onToggleItem: (item) => dispatch(toggleItemAction(item)),
    onItemsLoad: () => dispatch(fetchItems()),
    onStatusesLoad: () => dispatch(fetchStatuses()),
  };
}
