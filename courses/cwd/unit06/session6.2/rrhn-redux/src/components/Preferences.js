...
function mapStateToProps(state) {
  return {
    doCancelPrefs:          state.prefs.doCancelPrefs,
    doCloseAndApplyPrefs:   state.prefs.closeAndApplyPrefsAction,
    doEditListSize:         state.prefs.currentListSize,
    doEditColor:            state.prefs.currentColor
  }
}
