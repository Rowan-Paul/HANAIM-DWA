...
export class RrHNApp extends React.Component {
  ...
  markAsSeen = async () => {
    const listItems = this.state.items
      .slice(0, this.state.preferences.listSize)
      .map(async (item) => {
          ...
          <div className="ItemList">
            ...
            <div id="ListMainContent">
              <ListItems
                ...
                listSize={this.state.preferences.listSize}
                data={this.state.items}
              />
            </div>
            <button onClick={this.markAsSeen} id="markAsSeen">
        ...
        <div id="ItemPanel">
          <Switch>
            ...
            <Route
              ...
              render={(routeProps) => (
                <Preferences
                  ...
                  dialogClickHandler={boundDialogClickHandler}
                  setListSize={boundSetListSize}
                  color={this.state.preferences.color}
                  listSize={this.state.preferences.listSize}
                  {...routeProps}
                />
              )}
            ...
            <Route
              path="/item/:id"
              render={(routeProps) => (
                <IFrameArea {...routeProps} items={this.state.items} />
              )}
            />
          </Switch>
        </div>
